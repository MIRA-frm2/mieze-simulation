...
"""A plotting scripts that plots individually the magnetic field for the MIEZE experimental_setup elements."""
...
def main():
    """Main program that plots the magnetic field of the elements in the MIEZE experimental_setup."""
